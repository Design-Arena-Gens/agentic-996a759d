      ...
      <main className="mx-auto flex w-full max-w-6xl flex-1 items-center justify-center px-6 py-20">
        <Card className="w-full max-w-md border-white/10 bg-white/[0.04] p-10">
          <div className="space-y-2 text-center">
            ...
            <p className="text-sm text-slate-400">14-day free trial. Cancel anytime. No credit card required.</p>
          </div>
          <form onSubmit={handleSubmit} className="mt-8 space-y-6">
            <div className="space-y-2">
              ...
              <Input
                ...
                name="name"
                type="text"
                placeholder="Taylor, Creator of StudioX"
                value={name}
            ...
            <Button type="submit" className="w-full" disabled={loading || !isHydrated}>
              {loading ? 'Creating workspace…' : 'Start your free trial'}
            </Button>
          </form>
